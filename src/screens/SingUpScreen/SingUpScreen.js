...
const INPUT_OPTIONS = {
  ApellidoPaterno: ['Alumno', 'Exalumno', 'ComunidadUNAM', 'Externo'],
  ApellidoMaterno: ['Alumno', 'Exalumno', 'ComunidadUNAM', 'Externo'],
  Nombre: ['Alumno', 'Exalumno', 'ComunidadUNAM', 'Externo'],
  Carrera: ['Alumno', 'Exalumno'],
  Password: ['Alumno', 'Exalumno', 'ComunidadUNAM', 'Externo'],
  VerifyPassword: ['Alumno', 'Exalumno', 'ComunidadUNAM', 'Externo'],
  AccountNumber: ['Alumno', 'Exalumno'],
  Semestre: ['Alumno'],
  Boton: ['Alumno', 'Exalumno', 'ComunidadUNAM', 'Externo'],
};

const DROPDOWN_OPTIONS = [
  {key: 'Alumno', value: 'Alumno'},
  {key: 'Exalumno', value: 'Exalumno'},
  {key: 'ComunidadUNAM', value: 'Comunidad UNAM'},
    ...
    <ScrollView>
      ...
      <Text style={styles.title}>Registrate</Text>
        <SelectList
          ...
          search={false}
        />
        {INPUT_OPTIONS['Carrera'].includes(status) && (
          <SelectList
            placeholder="Carrera"
            value={carrera}
        ...
        {INPUT_OPTIONS['Semestre'].includes(status) && (
          <SelectList
        ...
        {INPUT_OPTIONS['AccountNumber'].includes(status) && (
          <CustomImput
        ...
        {INPUT_OPTIONS['Password'].includes(status) && (
          <CustomImput
        ...
        {INPUT_OPTIONS['VerifyPassword'].includes(status) && (
          <CustomImput
        ...
        {INPUT_OPTIONS['Nombre'].includes(status) && (
          <CustomImput
            placeholder="Nombre"
            value={nombre}
            setValue={setNombre}
        ...
        {INPUT_OPTIONS['ApellidoPaterno'].includes(status) && (
          <CustomImput
        ...
        {INPUT_OPTIONS['ApellidoMaterno'].includes(status) && (
          <CustomImput
        ...
        {INPUT_OPTIONS['Boton'].includes(status) && (
